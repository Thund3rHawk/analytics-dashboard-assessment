            ...
            {selectedVehicle ? (
              <div className="space-y-4">
                <div className="p-4 bg-blue-50 rounded-lg">
                  ...
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-medium text-gray-700">Electric Range</span>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="font-medium text-gray-700">Legislative District</span>
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-medium text-gray-700">DOL Vehicle ID</span>
                  ...
                  <div className="flex justify-between items-center mb-2">
                    <span className="font-medium text-gray-700">Electric Utility</span>
                    <span className="text-xs text-gray-700">{selectedVehicle["Electric Utility"]}</span>
                  </div>
                  <div className="flex justify-between items-center">
                ...
                {/* Location Data */}
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h3 className="font-medium text-gray-700 mb-2">Vehicle Location</h3>
                  <div className="h-48 bg-blue-100 rounded-lg flex items-center justify-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <p className="text-white font-medium">{selectedVehicle["Vehicle Location"]}</p>
                      <p className="text-blue-100 text-sm mt-1">{selectedVehicle.City}, {selectedVehicle.State} {selectedVehicle["Postal Code"]}</p>
                    </div>
                  </div>
                </div>
              </div>
